...
public:
    ...
    QListWidget *listWidget_showlist;
    ...
    void setupUi(QDialog *music_player)
    {
        ...
        music_player->setWindowModality(Qt::NonModal);
        ...
        listWidget_showlist = new QListWidget(music_player);
        listWidget_showlist->setObjectName(QStringLiteral("listWidget_showlist"));
        listWidget_showlist->setGeometry(QRect(20, 280, 256, 192));
