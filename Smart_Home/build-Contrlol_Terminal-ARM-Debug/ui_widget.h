...
"border-image: url(:/picture/light.jpg);"));
        pushButton_2 = new QPushButton(Widget);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(170, 140, 90, 90));
        pushButton_2->setFont(font);
        pushButton_2->setStyleSheet(QStringLiteral("border-image: url(:/picture/house_app.jpg);"));
        pushButton_3 = new QPushButton(Widget);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(300, 140, 90, 90));
        pushButton_3->setFont(font);
        pushButton_3->setStyleSheet(QLatin1String("border-image: url(:/picture/curtain.jpg);\n"
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 178, 102, 255), stop:0.55 rgba(235, 148, 61, 255), stop:0.98 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 0));"));
        ...
        pushButton_4->setStyleSheet(QLatin1String("border-image: url(:/picture/lock.jpg);\n"
"border-color: qconicalgradient(cx:0, cy:0, angle:135, stop:0 rgba(255, 255, 0, 69), stop:0.375 rgba(255, 255, 0, 69), stop:0.423533 rgba(251, 255, 0, 145), stop:0.45 rgba(247, 255, 0, 208), stop:0.477581 rgba(255, 244, 71, 130), stop:0.518717 rgba(255, 218, 71, 130), stop:0.55 rgba(255, 255, 0, 255), stop:0.57754 rgba(255, 203, 0, 130), stop:0.625 rgba(255, 255, 0, 69), stop:1 rgba(255, 255, 0, 69));"));
        ...
        pushButton_6->setStyleSheet(QStringLiteral("border-image: url(:/picture/setting.jpg);"));
